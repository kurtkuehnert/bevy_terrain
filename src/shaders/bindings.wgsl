...
// terrain bindings
@group(1) @binding(0)
var<storage> terrain: Terrain;
@group(1) @binding(1)
var<uniform> attachments: Attachments;
@group(1) @binding(2)
var terrain_sampler: sampler;
@group(1) @binding(3)
var {0}_attachment: texture_2d_array<f32>;
@group(1) @binding(4)
var {1}_attachment: texture_2d_array<f32>;
@group(1) @binding(5)
var {2}_attachment: texture_2d_array<f32>;
@group(1) @binding(6)
var {3}_attachment: texture_2d_array<f32>;
@group(1) @binding(7)
var {4}_attachment: texture_2d_array<f32>;
@group(1) @binding(8)
var {5}_attachment: texture_2d_array<f32>;
@group(1) @binding(9)
var {6}_attachment: texture_2d_array<f32>;
@group(1) @binding(10)
var {7}_attachment: texture_2d_array<f32>;
