...
impl Coordinate {
    ...
    pub fn from_local_position(local_position: DVec3, is_spherical: bool) -> Self {
        if is_spherical {
    ...
    pub fn local_position(self, is_spherical: bool) -> DVec3 {
        if is_spherical {
            let xy =
    ...
    pub fn from_world_position(world_position: DVec3, model: &TerrainModel) -> Self {
        ...
        Self::from_local_position(local_position, model.is_spherical())
    }

    pub fn world_position(self, model: &TerrainModel, height: f32) -> DVec3 {
        let local_position = self.local_position(model.is_spherical());
