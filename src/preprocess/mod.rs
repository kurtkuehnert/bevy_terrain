...
// // };
// use crate::terrain_data::gpu_tile_atlas::create_attachment_layout;
//
...
//
//                 for attachment in gpu_tile_atlas.attachments.iter().flatten() {
...
//                         let attachment = &gpu_tile_atlas.attachments
//                             [task.task.tile.attachment_index as usize]
//                             .as_ref()
//                             .unwrap();
//
